    ...
    <div data-testid="gsea-overview" className="space-y-6">
      ...
      <div data-testid="gsea-heatmap" className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-background rounded-lg border border-border p-4">
          <div className="text-sm text-text-muted mb-1">Total Significant Pathways</div>
        ...
        <div className="bg-background rounded-lg border border-border p-4">
          <div className="text-sm text-text-muted mb-1">Overrepresented</div>
        ...
        <div className="bg-background rounded-lg border border-border p-4">
          <div className="text-sm text-text-muted mb-1">Underrepresented</div>
        ...
        <div className="bg-background rounded-lg border border-border p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
                ...
                return (
                  <>
                    <div className="flex justify-between items-center py-2 border-b border-border">
                      <span className="text-sm text-text-muted">Pathway Name</span>
                      <span className="text-sm font-medium text-text-primary text-right max-w-xs">
                        {pathwayName}
                      </span>
                    </div>

                    <div className="flex justify-between items-center py-2 border-b border-border">
                      <span className="text-sm text-text-muted">Term ID</span>
              ...
              <div className="flex justify-between items-center py-2 border-b border-border">
                <span className="text-sm text-text-muted">NES</span>
                <span
                  className={`text-sm font-medium ${
                    selectedPathway.nes > 0 ? 'text-primary' : 'text-secondary'
                  }`}
                >
              ...
              <div className="flex justify-between items-center py-2 border-b border-border">
                <span className="text-sm text-text-muted">Adj P-value (FDR)</span>
                <span className="text-sm font-medium text-text-primary">
              ...
              <div className="flex justify-between items-center py-2">
                <span className="text-sm text-text-muted">Gene Count</span>
                <span className="text-sm font-medium text-text-primary">
              ...
              <div className="bg-surface rounded-lg p-3 max-h-[200px] overflow-y-auto">
                <div className="flex flex-wrap gap-2">
                  {selectedPathway.lead_genes.slice(0, 20).map((gene) => (
                    <span
                      key={gene}
                      className="inline-flex px-2 py-1 text-xs font-medium bg-background border border-border rounded-md text-text-secondary"
                    >
                      {gene}
                    </span>
                  ))}
                  {selectedPathway.lead_genes.length > 20 && (
                    <span className="inline-flex px-2 py-1 text-xs text-text-muted">
