...
def validate_organism(organism: str) -> str:
    ...
    if organism not in valid_organisms:
        raise ValidationError(
            ...
            details={"provided": organism, "valid_options": valid_organisms},
        )
...
def validate_sort_column(
    sort_by: str, valid_columns: list[str], default: Optional[str] = None
) -> str:
    """
    ...
    if sort_by not in valid_columns:
        ...
        raise ValidationError(
            ...
            details={"sort_by": sort_by, "valid_columns": valid_columns},
        )
