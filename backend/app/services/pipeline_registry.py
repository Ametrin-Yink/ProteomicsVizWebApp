...
register(AnalysisTemplate.PROTEIN_PAIRWISE, [
    ...
    PipelineStep(5, "filter", "Filter by Criteria",
                 step_filter_criteria_default),
    PipelineStep(6, "protein_abundance", "Protein Abundance (msqrob2)",
                 step_protein_abundance_msqrob2),
...
register(AnalysisTemplate.DEQMS_PAIRWISE, [
    PipelineStep(1, "combine_replicates", "Combining Replicates",
                 step_combine_replicates),
    PipelineStep(2, "generate_unique_psm", "Generate Unique PSM (DEqMS)",
                 step_generate_unique_psm_deqms),
    PipelineStep(3, "remove_razor", "Remove Razor Peptides",
                 step_remove_razor),
    PipelineStep(4, "remove_low_quality", "Remove Low Quality",
    ...
    PipelineStep(5, "filter", "Filter by Criteria",
                 step_filter_criteria_default),
    PipelineStep(6, "protein_abundance", "Protein Abundance (DEqMS)",
                 step_protein_abundance_deqms),
    PipelineStep(7, "diff_expression", "Differential Expression (DEqMS)",
                 step_diff_expression_deqms),
    PipelineStep(8, "qc_metrics", "QC Metrics",
                 step_qc_metrics),
    PipelineStep(9, "gsea", "GSEA Analysis",
