"""Step 6: Protein abundance calculation (MSstats)."""
...
async def step_protein_abundance_msstats(ctx: StepContext) -> None:
    ...
    logger.info(
        f"Step 6 (MSstats): About to run protein abundance. "
