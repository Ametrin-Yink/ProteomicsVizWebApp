#!/usr/bin/env Rscript
#
# Verify MSstatsPTM Package Installation
#
# Checks that MSstatsPTM and Biostrings packages are installed.
# Exits with code 0 if all packages are available, 1 otherwise.
#
# Usage: Rscript verify_msstatsptm.R

cat("Verifying MSstatsPTM installation for Proteomics Visualization Web App\n")
cat("========================================================================\n\n")
...
if (length(missing_packages) == 0) {
    cat("\nSUCCESS: All required MSstatsPTM packages are installed.\n")
